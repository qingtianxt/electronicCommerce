		...
		<div class="row">
			...
			<div class="col-md-4">
				<form enctype="multipart/form-data"
					action="${pageContext.request.contextPath}/admin/front/user/userServlet?method=reg"
					...
					<div class="row-fluid">
						<div class="col-md-12">
							...
							<c:if test="${param.status.equals('2')}">
								<div class="alert alert-danger" role="alert">该用 户已存在</div>
							</c:if>
							<c:if test="${param.status.equals('3')}">
								<div class="alert alert-danger" role="alert">用户注册失败</div>
							</c:if>
						</div>
					</div>
				</form>
