...
<script type="text/javascript">
	$().ready(function() {
		$("#addItem").click(function() {
			...
			$.get("${pageContext.request.contextPath}/admin/front/shopping/shoppingServlet?method=addItem", {
				num : num,
				productId : productId
			}, function(data) {
...
<body data-spy="scroll">
	...
	<div class="info col-md-8 col-md-offset-2">
		...
		<dl class="col-sm-8 dl-horizontal">
			...
			<dd>
				<form
					action="${pageContext.request.contextPath}/admin/front/shopping/shoppingServlet?method=addItem&id=${productBean.id}"
					method="post">
