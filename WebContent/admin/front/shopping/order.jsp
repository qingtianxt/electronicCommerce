...
<body>
	...
	<form action="shoppingServlet?method=addOrder" role="form"
					...
					<div class="row-fluid">
						<c:forEach items="${productOrderBeans}" var="pItem">
							<table cellpadding="0" cellspacing="0" class="table">
								<tr>
									<td><a
										href="${pageContext.request.contextPath}/admin/front/productShow/productShowServlet?method=info&id=${pItem.productBean.id }">
											<img width="70px" height="70px"
											src="${pItem.productBean.pic}" />
									</a></td>
									<td><a
										href="${pageContext.request.contextPath}/admin/front/productShow/productShowServlet?method=info&id=${pItem.productBean.id}">${pItem.productBean.name}</a></td>
